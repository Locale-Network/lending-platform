      ...
      {!isLoading && !error && stats && (
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{stats.averageAPY.toFixed(1)}%</div>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <p className="font-semibold">{pool.totalInvestors}</p>
                  </div>
                  <div>
                    <p className="text-muted-foreground">Available</p>
                    <p className="font-semibold">${pool.availableLiquidity.toLocaleString()}</p>
                  </div>
                </div>
